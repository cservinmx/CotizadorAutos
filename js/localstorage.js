...
if (typeof(Storage) !== "undefined") {
  ...
  $(document).ready(function(){
    $(window).on("load", function() {
      ...
      if(  localStorage.getItem("op2modelo")){
          //Tab2
       ...
       if( localStorage.getItem("op3modelo")){
            //Tab3
    ...
    //  img3=getBase64Image(op3imagen);
      ...
      var op3dgarantia=document.getElementById("op3-dgarantia").value;

      // Guardo en localStorage

      //Tab1

      //localStorage.setItem("imagen", img1);
      ...
      //Tab2
    //  localStorage.setItem("op2imagen", img2);
      ...
      //localStorage.setItem("op3imagen", img3);
